...
-- Design a relational database for TechNova Solutions that manages employees, departments, and projects. The goal is to create, modify, and optimize the database structure while ensuring data integrity.
...
-- - Make sure each task assignment is linked to a specific employee and project by creating a Task_Assignments table with appropriate primary and foreign keys.
